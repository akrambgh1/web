    ...
    <>
      <section className="w-full h-screen max-md:h-[60vh] max-lg:h-[90vh] max-lg:mb-[2rem]">
        <div className="w-full h-full relative items-center justify-center">
          <div className="relative w-full h-full flex items-center justify-start bg-[#111111] overflow-hidden">
            <div className="flex flex-col gap-4 h-full max-2xl:w-[100%] max-md:w-full lg:w-[50%] px-10">
              <div className="flex flex-col h-full justify-center z-10 gap-4 max-md:gap-2 text-white tracking-tighter max-lg:items-center max-lg:text-center">
                <h1 className="text-[4.5rem] max-md:text-[1.75rem] max-xl:text-[3rem]">
                  ...
                  <i className="rounded-xl bg-[#2264f1] select-none px-4 text-black font-[500]"><span className="text--[#2264f1]">WEB</span>LOCATORS</i>
                </h1>
            ...
            <div className="absolute bottom-[-50%] left-[50%] translate-x-[-50%] w-[125%] max-lg:w-[200%] h-[75%] max-md:h-[85%] rounded-[90%] bg-white blur-3xl z-4 opacity-100"></div>
            ...
            <div className="absolute bottom-[-50%] left-[50%] translate-x-[-50%] max-lg:w-[170%] w-full h-[105%] max-md:h-[120%] rounded-[140%] bg-[#004ffa] blur-3xl z-2 opacity-40"></div>

            <div className="absolute bottom-[-50%] left-[50%] translate-x-[-50%] max-lg:w-[170%] w-full h-[120%] max-md:h-[130%] rounded-[140%] bg-[#2309b65b] blur-xl opacity-60 z-1"></div>
          </div>
        </div>
      </section>
    </>
