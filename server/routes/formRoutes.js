...
const { addNewsletterEmail , getNewsletterEmails } =require('../controllers/newsletterController')
...
router.get('/admin/emails',  getNewsletterEmails);
router.put('/status', updateFormStatus);
router.post('/emails', addNewsletterEmail);
